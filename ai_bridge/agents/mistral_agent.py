...
from ai_bridge.core.models import AgentResult, Task, TaskStatus, AgentHealth

class MistralAgent(ExternalAIAgent):
    provider = "mistral"

    def __init__(self, agent_id: str, security_manager: Any) -> None:
        super().__init__(agent_id, "https://api.mistral.ai/v1", 
    ...
    async def execute(self, task: Task) -> AgentResult:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                return self.result(task, "Mistral API error", TaskStatus.FAILED, 0.0, [str(e)])
